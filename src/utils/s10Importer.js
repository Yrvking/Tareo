...
export function parseResumenTareo(fileBuffer) {
  ...
  const fields = [
    ...
    { key: "partidaControl", label: "Partida de Control", aliases: ["partida de control", "partidacontrol"] },
    ...
    { key: "horasLaboradas", label: "Horas laboradas", aliases: ["horas laboradas", "horaslaboradas"] },
    { key: "horasDescanso", label: "Horas descanso", aliases: ["horas descanso", "horasdescanso"] },
    { key: "codigoPartida", label: "Código Partida de Control", aliases: ["codigo partida de control", "codigopartidadecontrol"] },
    { key: "tipoHora", label: "Tipo Hora", aliases: ["tipo hora", "tipohora"] },
    { key: "costoHHNormal", label: "Costo HH Normal", aliases: ["costo hh normal", "costohhnormal"] },
